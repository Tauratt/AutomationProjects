...
from Playwright_Automation_Project_1.Async.config import SCREENSHOT_DIR
from Playwright_Automation_Project_1.Async.utilities.utils import (
    log_message,
    error
)
from Playwright_Automation_Project_1.Async.helper_func.error_class import LocatorNotFoundError
from Playwright_Automation_Project_1.Async.utilities.utils import error
...
class Settings:
    ...
    async def get_screenshot(self, name_page):
        ...
        # прикрепить к Allure
        # allure.attach(open(screenshot_path, 'rb').read(),
        #               name = "Screenshot",
