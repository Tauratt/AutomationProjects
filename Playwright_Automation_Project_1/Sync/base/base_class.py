...
from Playwright_Automation_Project_1.Sync.config import SCREENSHOT_DIR
from Playwright_Automation_Project_1.Sync.utilities.utils import (
    log_message,
    error
)
from Playwright_Automation_Project_1.Sync.helper_func.error_class import LocatorNotFoundError
from Playwright_Automation_Project_1.Sync.utilities.utils import error
...
class Settings:
    ...
    def get_screenshot(self, name_page):
        ...
        self.page.screenshot(path=SCREENSHOT_DIR / name_screenshot)
