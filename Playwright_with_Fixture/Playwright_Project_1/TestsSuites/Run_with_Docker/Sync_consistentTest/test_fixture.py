...
from Playwright_with_Fixture.Playwright_Project_1.Sync.fixtures.conftest_server import *
...
def test_specified_browsers1(browser_docker_session):
    context1 =  browser_docker_session.new_context(no_viewport=True)
...
# def test_specified_browsers2(browser_docker_session):
#     context1 =  browser_docker_session.new_context(no_viewport=True)
#     page1 =  context1.new_page()
#     page1.goto("https://www.saucedemo.com/")
#
...
# def test_firefox(browser_docker_firefox):
#     context1 =  browser_docker_firefox.new_context(no_viewport=True)
#     page1 =  context1.new_page()
#     page1.goto("https://www.saucedemo.com/")
#
#     run_test_suite(page1, name_browser='firefox')
...
# def test_chrome(browser_docker_chromium):
#     context1 =  browser_docker_chromium.new_context(no_viewport=True)
#     page1 =  context1.new_page()
#     page1.goto("https://www.saucedemo.com/")
#
...
#
#
# """Фикстура возвращающая все браузеры(chrom, firefox) - universal_docker_browsers"""
# def test_browsers(universal_docker_browsers):
#     context1 =  universal_docker_browsers["firefox"].new_context(no_viewport=True)
#     page1 =  context1.new_page()
#     page1.goto("https://www.saucedemo.com/")
#
#     run_test_suite(page1, name_browser='firefox')
