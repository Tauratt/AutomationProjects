...
"""Фикстура - browser_mobile_chromium"""
# async def test_chrome(browser_mobile_chromium):
#     browser, p = browser_mobile_chromium
#     device_config = p.devices["iPhone 14 Pro"]
#
#     context1 = await browser.new_context(**device_config)
...
async def universal_browsers_test_chrome(universal_browsers_mobile_sessions):
...
"""Фикстура C указанием браузера - browser_mobile_session"""
async def test_firefox1(browser_mobile_firefox):
...
async def test_res(browser_mobile_firefox):
    await test_firefox1(browser_mobile_firefox)
    await test_firefox2(browser_mobile_firefox)